    ...
    experience: [
      {
        ...
        description: [
          ...
          },
          {
            ...
            items: ["Error protocol improvements", "HTTP foundation modifications", "Response parser implementation"],
          },
          {
        ...
        description: [
          {
            ...
            items: ["Clean Architecture を用いた UI やシステムロジックの実装", "C++ を用いたネイティブプラグイン開発"],
          },
          {
