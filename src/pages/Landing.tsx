...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="flex items-start justify-center px-4 h-full pt-40">
      <div className="max-w-sm w-full text-center space-y-4">
        ...
        <div className="relative mx-auto w-40 h-40 md:w-48 md:h-48">
          <img 
            ...
            className="w-full h-full rounded-full object-cover shadow-lg ring-4 ring-tn-accent-blue/20"
          />
        </div>

        {/* Name & Title */}
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold text-tn-text-primary leading-relaxed">
            hashiiiii
          </h1>
          <p className="text-tn-text-secondary text-base leading-relaxed">
            <span className="text-tn-text-primary font-medium">Engineer</span>
            <span className="text-tn-text-muted mx-2">·</span>
        ...
        <div className="flex justify-center space-x-4">
          <a
            ...
            className="p-3 rounded-full bg-tn-bg-tertiary hover:bg-tn-accent-blue/10 text-tn-text-muted hover:text-tn-accent-blue transition-all duration-200 hover:scale-110"
            aria-label="GitHub"
          >
