...
let cachedContentValidation: { posts: Map<string, BlogPostWithContent>; errors: ValidationError[] } | null = null;
  ...
  describe("Individual Post Validation", () => {
    ...
    it("should validate tags as array of strings", () => {
      const invalidPost = {
        ...
        html: "",
        date: "2023-12-25",
        tags: ["valid-tag", 123, null, ""] as unknown as string[], // Invalid tag types
        readTime: "5 min read",
      } as BlogPostWithContent;
    ...
    it("should reject invalid published field type", () => {
      const invalidPublished = {
        ...
        tags: ["test"],
        readTime: "5 min read",
        published: "yes" as unknown as boolean, // Invalid type
      } as BlogPostWithContent;
...
`;
  ...
  describe("Real Content Directory Validation", () => {
    let contentValidation: { posts: Map<string, BlogPostWithContent>; errors: ValidationError[] };
